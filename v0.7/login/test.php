      ...
      <div id="login">
         ...
         <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <div class="input-group" style="display:inline">
                                    <input type="date" class="form-control" id="date" style="text-align: center" onChange="GoAffectation(this.value)"><br>
                                    <a id="LienVersExp" href="../exp/index.php"><button type="button" class="btn btn-info" style="margin-top : 2%">Accès Exploitation</button></a><a href="../main/index.php" id="LienVersMain"><button type="button" class="btn btn-warning" style="margin-left : 2%;margin-top : 2%">Accès Maintenance</button></a>
                                 </div>
                              </div>
                           </div>
                     </div>
               ...
               <a id="lienhistorique" href="../exp/index.php?save=1" ><button type="button" id="btn_openHistorique" class="btn btn-default" disabled>Ouvrir</button></a>
               </div>
               </div>
               </form>
               </p>
