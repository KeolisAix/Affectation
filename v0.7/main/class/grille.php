    ...
    public function setGrilleService($_NumService, $HD, $HF, $HDC1, $HFC1, $HDC2, $HFC2, $Voiture, $Voiture1, $Voiture2, $Heure_Service, $Ligne)
    {
        ...
        //echo "COUPE1";
            ...
            for ($i = 1; $i <= $NbdequartfonctionnementCoupé; $i++) {
                if($i == 1 ){
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Ligne : <b>'.$Ligne.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC1.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'"></td>';
                }else{
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Ligne : <b>'.$Ligne.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC1.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'"></td>';
                }
            }
            ...
            for ($i = 1; $i <= $NbdequartfonctionnementCoupé; $i++) {
                if($i == 1 ){
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC1.'</b><br>Ligne : <b>'.$Ligne.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'"></td>';
                }else{
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC1.'</b><br>Ligne : <b>'.$Ligne.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'"></td>';
                }
            }
            ...
            for ($i = 1; $i <= $NbdequartfonctionnementCoupédeux; $i++) {
                if($i == 1 ){
                    echo '<td class="fonctionnement coupe deux" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture2.'</b><br>Ligne : <b>'.$Ligne.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC2.'</b><br>Heure de Fin : <b>'.$HFC2.'</b>" id="_coupe'.$_NumService.'"></td>';
                }else{
                    echo '<td class="fonctionnement coupe deux" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture2.'</b><br>Ligne : <b>'.$Ligne.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC2.'</b><br>Heure de Fin : <b>'.$HFC2.'</b>" id="_coupe'.$_NumService.'"></td>';
                }
            }
