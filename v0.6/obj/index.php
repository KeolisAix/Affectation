...
<html>
    <head>
    <title>Affectation - v0.6 - 14/04/2016</title>
...
while ($row = $getServiceSQL->fetch()) {
    ...
    if ($precedentA == $row['code_tache']) {
        if ($precedentH != $row['arret_debut_heure']) {
            ...
            echo '<tr onMouseOut="javascript:this.style.background=\'#ffffff\'" onMouseOver="javascript:this.style.background=\'#F5F5F5\'" id="' . $precedentA . $precedentV . '" class="' . $precedentA . $precedentV . $row['code_service'] . '"><td  class="redips-mark" style="font-style: italic;text-align: center;font-weight: bold;">' . $row["code_tache"] . '</td>';
        ...
        echo '<tr onMouseOut="javascript:this.style.background=\'#ffffff\'" onMouseOver="javascript:this.style.background=\'#F5F5F5\'" id="' . $row["code_tache"] . '" class="' . $row["code_tache"] . '"><td  class="redips-mark" style="font-style: italic;text-align: center;font-weight: bold;">' . $row["code_tache"] . '</td>';
	...
	<tbody>
		<tr>
            <td class="reset" id="HelloCitaro">
                <?php
echo '<div class="redips-drag ui-widget-content dontmove" style="border-style: solid; width: 100%; background-color: beige">CITARO<input type="checkbox" id="checkcitaro" onchange="hide(this.id,\'HelloCitaro\')"></div>';
    ...
    <tbody>
        <tr>
            <td class="reset" id="HelloCity">
                <?php
echo '<div class="redips-drag ui-widget-content dontmove" style="border-style: solid; width: 100%; background-color: honeydew">CITY<input type="checkbox" id="checkcity" onchange="hide(this.id,\'HelloCity\')"></div>';
    ...
    <tbody>
        <tr>
            <td class="reset" id="HelloCrossway">
                <?php
echo '<div class="redips-drag ui-widget-content dontmove" style="border-style: solid; width: 100%; background-color: lavender">CROSSWAY<input type="checkbox" id="checkcrossway" onchange="hide(this.id,\'HelloCrossway\')"></div>';
    ...
    <tbody>
        <tr>
            <td class="reset" id="HelloGX">
                <?php
echo '<div class="redips-drag ui-widget-content dontmove" style="border-style: solid; width: 100%; background-color: lemonchiffon">GX<input type="checkbox" id="checkgx" onchange="hide(this.id,\'HelloGX\')"></div>';
    ...
    <tbody>
        <tr>
            <td class="reset" id="HelloSetra">
                <?php
echo '<div class="redips-drag ui-widget-content dontmove" style="border-style: solid; width: 100%; background-color: lightgrey">SETRA<input type="checkbox" id="checksetra" onchange="hide(this.id,\'HelloSetra\')"></div>';
