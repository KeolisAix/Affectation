...
class Grille
{
    ...
    public function setGrilleService($_NumService, $HD, $HF, $HDC1, $HFC1, $HDC2, $HFC2, $Voiture, $Voiture1, $Voiture2)
    {
        ...
        //echo "PASDECOUPE";
            ...
            for ($i = 1; $i <= $Nbdequartfonctionnement; $i++) {
                echo '<td class="fonctionnement" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture.'</b><br>Heure de début : <b>'.$HD.'</b><br>Heure de Fin : <b>'.$HF.'</b>" style="background-color: #00ace6"></td>';
            }
        ...
        //echo "COUPE1";
            ...
            for ($i = 1; $i <= $Nbdequartfonctionnement; $i++) {
                echo '<td class="fonctionnement" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HD.'</b><br>Heure de Fin : <b>'.$HF.'</b>" style="background-color: #00ace6"></td>';
            }
            ...
            for ($i = 1; $i <= $NbdequartfonctionnementCoupé; $i++) {
                if($i == 1 ){
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Coupé : <b>Oui 1</b><br>Heure de début : <b>'.$HDC1.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'" style="background-color: #00ace6"></td>';
                }else{
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Coupé : <b>Oui 1</b><br>Heure de début : <b>'.$HDC1.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'" style="background-color: #00ace6"></td>';
                }
            }
            ...
            for ($i = 1; $i <= $NbdequartfonctionnementCoupé; $i++) {
                if($i == 1 ){
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC1.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'" style="background-color: #00ace6"></td>';
                }else{
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture1.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC1.'</b><br>Heure de Fin : <b>'.$HFC1.'</b>" id="_coupe'.$_NumService.'" style="background-color: #00ace6"></td>';
                }
            }
            ...
            $NbdequartfonctionnementCoupé = $this->dateDiff($HDC2, $HFC2,0);
            for ($i = 1; $i <= $NbdequartfonctionnementCoupé; $i++) {
                if($i == 1 ){
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture2.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC2.'</b><br>Heure de Fin : <b>'.$HFC2.'</b>" id="_coupe'.$_NumService.'" style="background-color: #00ace6"></td>';
                }else{
                    echo '<td class="fonctionnement coupe" title="<center>Service : Agent</center><br>Agent : <b>'.$Voiture2.'</b><br>Coupé : <b>Oui</b><br>Heure de début : <b>'.$HDC2.'</b><br>Heure de Fin : <b>'.$HFC2.'</b>" id="_coupe'.$_NumService.'" style="background-color: #00ace6"></td>';
                }
            }
