...
<html>
    <head>
    <title>Affectation - v0.9 - Maintenance - <?php echo $DateDeAffectation; ?></title>
        <link rel="stylesheet" href="../config/css/style_maintenance.css" type="text/css" media="screen"/>
        <link rel="stylesheet" href="../config/css/style_maintenance_print.css" type="text/css" media="print"/>
        ...
        <script type="text/javascript" src="../config/js/maintenance.js"></script>
