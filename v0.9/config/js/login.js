    ...
    if (document.getElementById("lienhistorique").href.indexOf("&") < 0) {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                document.getElementById("lienhistorique").href = document.getElementById("lienhistorique").href + "&id=" + document.getElementById("selectversion").options[document.getElementById("selectversion").selectedIndex].value + "&day=" + tab_jour[ladate.getDay()] + "&date=" + ladatehistorique + "&periode=" + periode[1];
                console.log(xmlhttp.responseText)
                console.log(document.getElementById("lienhistorique").href)
            }
        }
