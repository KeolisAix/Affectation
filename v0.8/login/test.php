                                ...
                                <p>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <a id="lienhistorique" href="../exp/index.php?save=1">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" role="form" style="background: transparent">
                                <p>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <button type="button" class="btn btn-default" id="BtnImporterCSV" disabled=true onclick="document.location.href='../import/index.php'">Importer</button>
                                        </div>
                                    </div>
                        </div>
                    </div>
