...
class Voiture
{
    ...
    public function __construct($serviceAgent, $heureDebut, $heureFin, $ligne) // Constructeur demandant 4 paramètres
    {
        ...
        $this->setLigne($ligne); // Initialisation de l'heure du fin de service.
    }
    ...
    {
        if (!is_string($ligne)) // S'il ne s'agit pas d'un String.
        {
            trigger_error('La ligne n\'est pas bonne.', E_USER_WARNING);
            return;
        }
        $this->_Ligne = $ligne;
    }
